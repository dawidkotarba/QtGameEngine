...
const int FIGHTER_PARTICLES_OFFSET_X = -15;
const int FIGHTER_PARTICLES_OFFSET_Y = 3;

// weapons
const int WEAPON_DEFAULT_DAMAGE = 50;
const QPoint WEAPON_DEFAULT_ENEMY_RECOIL(1,0);

const int WEAPON_ROCKET_FIRE_RATE = 30;
const int WEAPON_ROCKET_SPEED = 10;
const int WEAPON_ROCKET_DAMAGE = 500;
const int WEAPON_ROCKET_PARTICLE_OFFSET_X = 0;
const int WEAPON_ROCKET_PARTICLE_OFFSET_Y = -2;
const int WEAPON_ROCKET_OFFSET_X = 80;
const int WEAPON_ROCKET_OFFSET_Y = 25;

const int WEAPON_BULLET_FIRE_RATE = 12;
const int WEAPON_BULLET_DAMAGE = 30;
const int WEAPON_BULLET_SPEED = 15;
const int WEAPON_BULLET_OFFSET_X = 50;
const int WEAPON_BULLET_OFFSET_Y = 26;

const int ENEMY_WEAPON_ROCKET_SPEED = -10;
const int ENEMY_WEAPON_ROCKET_OFFSET_X = -50;
const int ENEMY_WEAPON_ROCKET_OFFSET_Y = 30;

// enemies
const int ENEMY_UFO_PARTICLES_OFFSET = -50;
const int ENEMY_UFO_EXPLOSION_OFFSET = -40;
const int ENEMY_UFO_SPEED = 5;
const int ENEMY_UFO_SIN_FACTOR = 50;
const int ENEMY_UFO_SIN_OFFSET = 10;

const int ENEMY_UFO2_SPEED = 10;
const int ENEMY_UFO2_SIN_FACTOR = 150;
const int ENEMY_UFO2_SIN_OFFSET = 1;

const int ENEMY_UFO3_SPEED = -12;

const int ENEMY_ASTEROID_SPEED = -1;
const int ENEMY_ASTEROID_HEALTH = 150;
const int ENEMY_ASTEROID_CHILD_HEALTH = 100;
...
const int ENEMY_SHIP_PARTICLES_OFFSET = -50;
